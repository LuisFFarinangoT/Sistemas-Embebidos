...
float Pc = 0.0;// variables de kalman
float G = 0.0;// variables de kalman
float P = 1.0;// variables de kalman
float Xp = 0.0;// variables de kalman
float Zp = 0.0;// variables de kalman
float Xe = 0.0;// variables de kalman
void setup() {
  Serial.begin(9600);
}
void loop(){}
